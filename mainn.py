...
def send_text(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "An error has occured , contact admin @PowerDefend  ")
...
def how_to_help(message):
    bot.send_message(message.chat.id, "• Contact @PowerDefend    \n\n• Use /faq for more help")


@bot.message_handler(commands=['faq'])
def how_faq(message):
    bot.send_message(message.chat.id, "• Please use your mind for tutorial videos, and more helpful information (FAQ > Bot Help). \n\n• Op\n\n• Buy Here: @PowerDefend/otp-bot")
